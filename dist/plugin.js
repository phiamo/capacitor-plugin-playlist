var capacitorPlaylist = (function (exports, core) {
    'use strict';
    ...
    (function (RmxAudioStatusMessage) {
         ...
         */
        RmxAudioStatusMessage[RmxAudioStatusMessage["RMXSTATUS_ITEM_MOVED"] = 112] = "RMXSTATUS_ITEM_MOVED";
        /**
         * An item in the playlist has been replaced in place.
         */
        RmxAudioStatusMessage[RmxAudioStatusMessage["RMXSTATUS_ITEM_REPLACED"] = 113] = "RMXSTATUS_ITEM_REPLACED";
        /**
    ...
    class RmxAudioPlayer {
        ...
        constructor() {
             ...
             */
            this.replaceItem = (replacement, spec) => {
                if (!replacement) {
                    throw new Error('Provided track is null or not an audio track');
                }
    ...
    class PlaylistWeb extends core.WebPlugin {
        ...
        moveItem(options) {
            ...
            this.updateStatus(exports.RmxAudioStatusMessage.RMXSTATUS_ITEM_MOVED, { from, to, currentIndex: this.getCurrentIndex() }, item.trackId);
            return Promise.resolve();
        }
        async replaceItem(options) {
            ...
            this.updateStatus(exports.RmxAudioStatusMessage.RMXSTATUS_ITEM_REPLACED, replacement, replacement.trackId);
            return Promise.resolve();
        }
        async clearAllItems() {
            await this.release();
