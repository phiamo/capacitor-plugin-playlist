...
import type { AudioPlayerEventHandler, AudioPlayerEventHandlers, AudioPlayerOptions, AudioTrack, AudioTrackRemoval, OnStatusCallback, OnStatusCallbackUpdateData, OnStatusErrorCallbackData, OnStatusTrackChangedData, PlaylistItemOptions } from './interfaces';
export declare class RmxAudioPlayer {
     ...
     */
    replaceItem: (replacement: AudioTrack, spec: {
        index?: number;
        trackId?: string;
    }) => Promise<void>;
    /**
